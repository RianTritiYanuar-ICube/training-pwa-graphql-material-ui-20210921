...
import { Container, Box, Card, CardMedia, CardContent, Typography, Button, Grid, Stack, Snackbar } from '@mui/material';
          ...
          <Box sx={{ display: 'flex' }}>
            ...
            <CardContent>
              ...
              <Typography variant="subtitle1" color="text.secondary" component="div">
                {product.price_range.maximum_price.final_price.value} {product.price_range.maximum_price.final_price.currency}
              </Typography>
            ...
            <Grid container spacing={2}>
              <Grid item xs={4}>
                <Stack direction="row" spacing={2}>
                  <Button variant="contained" size="large" onClick={() => handleQty('minus')} fullWidth>
                    -
                  </Button>
                  <Typography component="div" variant="h5">
                    {quantity}
                  </Typography>
                  <Button variant="contained" size="large" onClick={() => handleQty('plus')} fullWidth>
                    +
                  </Button>
                </Stack>
              </Grid>
              <Grid item xs={8}>
                <Button 
                  ...
                  disabled={isProcessing ? true : product.stock_status == "IN_STOCK" ? false : true}
                  fullWidth 
                >
                  {product.stock_status == "IN_STOCK" ? "Bungkus Ke Cart" : "Stok Habis Nih"}
                </Button>
              </Grid>
            </Grid>
          </Container>
